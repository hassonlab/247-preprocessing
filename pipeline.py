...
def main():
    ...
    if '2' in steps: subject_prep(subject_n)
    else: print('Skipping step_002: subject_prep')
    ...
    for file in subject_n.audio_deid_files:
        ...
        if '3' in steps:
            ...
            ecog_prep(ecog_file)
        else: print('Skipping step_003: ecog_prep')
        ...
        else: print('Skipping step_004: audio_prep')
        if '5' in steps:
